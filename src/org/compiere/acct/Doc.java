...
public abstract class Doc
{
	...
	public int getValidCombination_ID (int AcctType, MAcctSchema as)
	{
		...
		// Xpande. Gabriel Vila. 07/10/2018.
		// Multiples cambios en este metodo para obtener la combinación contable.
		// Esto debido a que en el plan de cuentas se definen cuentas para distintas monedas, por ejemplo: Accreedores UYU y Acreedores USD.
		// Lleva a que en las pestañas contabilidad de algunas entidades como ser Socio de Negocio, pueda definir una cuenta contable por
		// moneda.
