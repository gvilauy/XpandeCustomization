...
public final class FactLine extends X_Fact_Acct
{
	...
	public void setDocumentInfo(Doc doc, DocLine docLine)
	{
		...
		// Xpande. Gabriel Vila. 24/07/2018. Nuevos atributos de linea de asiento
		if (m_doc != null){
			set_Value("C_DocType_ID", m_doc.getC_DocType_ID());
			set_Value("DocumentNoRef", m_doc.getDocumentNo());
		}
		// Fin Xpande
