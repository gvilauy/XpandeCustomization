...
public class MAccount extends X_C_ValidCombination
{
		...
		int User1_ID, int User2_ID, int User3_ID, int User4_ID , int UserElement1_ID, int UserElement2_ID, String trxName)
	{
		...
		// Xpande. Gabriel Vila. 22/09/2019.
		// Si tengo mas de una combinación contable con estas condiciones, el firstOnly me da un error.
		// Comento y sustituyo por un simple .first
