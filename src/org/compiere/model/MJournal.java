...
public class MJournal extends X_GL_Journal implements DocAction, DocOptions {
	...
	public String prepareIt()
	{
		...
		// Comento validación de Período Standard que viene en ADempiere.
		...
		*/
		...
		for (int i = 0; i < lines.length; i++)
		{
			...
			// Xpande. Gabriel Vila. 16/11/2018.
			// En el afterSave de las lineas actualiza totales del cabezal utilizando los campos AmtACCT.
			// Pero para el control de balanceo, suma los campos AmtSOURCE, lo cual provoca que cuando hay multimoneda, el asiento
			// si bien cierra en los totales del cabezal, no cierre en este control.
			// Esto es un bug de ADempiere.
			// Comento y sustituyo lineas.
