...
public class MPaymentTerm extends X_C_PaymentTerm
{
	...
	private boolean applySchedule (MInvoice invoice)
	{
		...
		for (int i = 0; i < m_schedule.length; i++)
		{
			...
			// Xpande. Gabriel Vila. 25/06/2021.
			// Agrego el literal de cuota correspondiente a este vencimiento
			String cuota = (i + 1) + "/" + m_schedule.length;
			ips.set_ValueNoCheckE("QuoteText", cuota);
			// Fin Xpande
