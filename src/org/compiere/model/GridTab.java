...
public class GridTab implements DataStatusListener, Evaluatee, Serializable
{
	...
	/***
	 * Si esta tab esta parametrizada para refrescar visibilidad de columnas al activarse según logica de despliegue de cada field.
	 * Xpande. Created by Gabriel Vila on 7/25/18.
	 * @return
	 */
	public boolean isDisplayGridRefresh(){
		return m_vo.IsDisplayGridRefresh;
	}
	// Fin Xpande
