...
public class MJournalLine extends X_GL_JournalLine
{
	...
	private void fillDimensionsFromCombination()
	{
		if (getC_ValidCombination_ID() > 0)
		{
			...
			// Xpande. Gabriel Vila. 20/06/2019.
			// Si la combinación contable no tiene producto asociado, pero esta linea de asiento tiene un producto selecccionado manualmente,
			// adempiere lo sustituye por nulo, cuando debe respetar el valor actual. Lo mismo para el socio de negocio.
			// Comento lineas y sustituyo
