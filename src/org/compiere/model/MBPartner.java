...
public class MBPartner extends X_C_BPartner
{
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		if (newRecord && success)
		{
			...
			// Xpande. Gabriel Vila. 22/12/2020.
			// En el modelo contable actual, no es necesaario copiar las cuentas contables
			// del grupo o esquema comtable, a la contabilidad de este socio.
			// Ya que el sistema escala hacia arriba buscando la cuenta.
			// Comento el código original.
