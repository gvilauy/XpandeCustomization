...
public class MInvoicePaySchedule extends X_C_InvoicePaySchedule
{
	...
	public MInvoice getParent ()
	{
		...
		// Xpande. Gabriel Vila. 26/08/2017. Issue #6.
		// Si m_parent sigue siendo null, intengo instanciar sin el get_TrxName() que ha dado problemas.
		if ((m_parent == null) || (m_parent.get_ID() <= 0)){
			m_parent = new MInvoice (getCtx(), getC_Invoice_ID(), null);
		}
		// Xpande.
