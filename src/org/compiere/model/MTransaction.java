...
public class MTransaction extends X_M_Transaction
{
	...
	static public MTransaction get(MInOutLine line , int M_ASI_ID)
	{
		...
		// Xpande. Gabriel Vila. 31/10/2018.
		// Por problemas al reactivar una recepción de procuctos (M_InOut), tengo que eliminar datos de stock que se generaron
		// previamente al completar. Al no hacerlo aun en la reactivación, me da un error por dos registros con misma clave en la
		// tabla M_Transaction. Por ahora sustituyo el .firstonly  por .first.
