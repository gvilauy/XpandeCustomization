...
public final class ImpFormat
{
	...
	/*******************************************************************************************************************
	 * CUSTOMIZACION XPANDE
	 ********************************************************************************************************************
	 */


	/***
	 *  Xpande. Created by Gabriel Vila on 5/29/17.
	 *  Customizacion. Retorna ID del registro insertado.
	 *  Insert/Update Database.
	 *  @param ctx context
	 *  @param line line
	 *  @param trxName transaction
	 ...
	 */
	public int updateDB (String line, Properties ctx, String trxName)
	{
		int ID = 0;
	 ...
	 *	@return ID del registro insertado.
	 */
	public int XpandeUpdateDB (String line, Properties ctx, String trxName)
	{
		int ID = 0;
